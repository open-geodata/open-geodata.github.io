...
$$
Varia\textit{\c{c}}\tilde{a}o = \left(\frac{Valor\;testado\;que\;falhou} {Objetivo_i}\right)-1
$$
...
$$
Varia\textit{\c{c}}\tilde{a}o = \left(\frac{Objetivo_i}{Valor\;testado\;que\;falhou}\right)-1
$$
...
$$
snv = \frac{ \sum_{i=1}^{n}  Varia\textit{\c{c}}\tilde{o}es_i }{Nº\;Total\;de\;Testes}
$$
