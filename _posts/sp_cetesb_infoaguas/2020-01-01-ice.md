...
Para o cálculo de F2 é necessário calcular a proporção do número de amostras deconformes (de todas os parâmetros empregados na análise) em um dado período de tempo.
$$
\begin{align}
